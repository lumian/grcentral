...
$lang['settings_index_update_release_url']					= "Go to the release page";
...
$lang['settings_syssettings_fw_update_only_friend_help']	= "If enabled, then update devices only if they are present in the database and activated.";
...
$lang['settings_syssettings_pb_generate_enable_help']		= "If you enable this option, you will be able to generate and receive Phonebook XML files by devices. If you disable this option, the phonebook section will not be disabled, and instead of the phonebook xml file, the error 404 will be returned.";
