...
$lang['devices_index_btn_import']							= "Импорт устройств";
$lang['devices_index_btn_infotitle']						= "Инфо";
// Главная страница: Модальное окно "Импорт устройств"
$lang['devices_index_modalimport_title']					= "Импорт устройств";
$lang['devices_index_modalimport_csv']						= "Содержимое CSV";
$lang['devices_index_modalimport_csv_help']					= "Информация об устройствах в CSV формате. <br />Подробнее про формат данных см. на wiki проекта на github.";
...
$lang['devices_index_flashdata_import_title_error']			= "Ошибка импорта";
$lang['devices_index_flashdata_import_1ststring_error']		= "строка заголовка не соответствует эталонной, проверьте шаблон и повторите попытку.";
$lang['devices_index_flashdata_import_1staccdis_error']		= "отключен аккаунт №1 на устройстве в строке";
$lang['devices_index_flashdata_import_collectdata_error']	= "не удалось собрать данные аккаунтов для устройства в строке";
$lang['devices_index_flashdata_import_model_error']			= "не удалось определить модель устройства в строке";
$lang['devices_index_flashdata_import_convert_error']		= "не удалось сконвертировать данные из CSV в массив данных. Проверьте корректность введенных данных.";
$lang['devices_index_flashdata_import_form_error']			= "не получены данные из формы.";
$lang['devices_index_flashdata_import_success']				= "Импорт устройств прошел успешно. Импортировано устройств:";
//
