...
// Страница абоненты
//
$lang['phonebook_abonents_description_text']					= "В данном разделе вы можете просмотреть справочник абонентов, сформированный на основе ваших данных. Редактирование возможно только для добавленных вручную абонентов.";
