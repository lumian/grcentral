...
$lang['settings_syssettings_cfg_enable_get_help']			= "В случае отключения, аппаратам всегда будет отдаваться ошибка 404 на запрос нового CFG файла.";
...
$lang['settings_syssettings_fw_enable_update_help']			= "В случае отключения, аппаратам всегда будет отдаваться ошибка 404 на запрос обновления.";
...
$lang['settings_syssettings_pb_generate_enable_help']		= "При включении данной функции, будет доступна возможность генерации и получения Phonebook XML файлов аппаратами. При отключении данной функции, раздел справочника отключен не будет, а вместо phonebook xml файла, будет отдаваться ошибка 404 (Not found).";
...
// Раздел "Системные настройки": Кнопки
$lang['settings_syssettings_btn_reset_settings']			= "Сбросить настройки";
// Раздел "Системные настройки": Модальное окно "Сброс настроек"
