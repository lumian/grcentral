...
//
$lang['devices_index_description_text']						= "В данном разделе осуществляется управление устройствами. Управление SIP аккаунтами производится по кнопке \"Инфо\".<br />Примечание: Отключенные устройства не получают настроек от сервера.";
