...
$lang['settings_tabs_title_importexport']					= "Импорт/Экспорт";
//
// Главная страница
//
...
$lang['settings_index_update_release_url']					= "Перейти на страницу релиза";
...
//
$lang['settings_importexport_pagetitle']					= "Импорт/Экспорт настроек";
$lang['settings_importexport_description_text']				= "В данном разделе вы можете импортировать или экспортировать настройки системы GRCentral.";
$lang['settings_importexport_models_title']					= "Модели / Группы моделей";
$lang['settings_importexport_models_descr']					= "Импорт/Экспорт настроек моделей и групп моделей устройств.";
$lang['settings_importexport_models_export_title']			= "Экспорт";
$lang['settings_importexport_models_export_descr']			= "Экспорт моделей и групп моделей уже настроенных в системе.<br />Поделитесь этим файлом с сообществом в <a href='https://github.com/lumian/grcentral/discussions' target='_blank'>Github</a>.<br />Выгрузка происходит в JSON формате.";
$lang['settings_importexport_models_import_title']			= "Импорт";
$lang['settings_importexport_models_import_descr']			= "Импорт моделей и групп моделей в систему из готовых шаблонов или полученных с другого сервера GRCentral.<br />Загрузка происходит в JSON формате.";
// Страница "Импорт/Экспорт": Модальное окно "Импорт моделей"
$lang['settings_importexport_modal_importmodel_title']		= "Импорт моделей и групп моделей";
$lang['settings_importexport_modal_importmodel_json']		= "Данные JSON";
$lang['settings_importexport_modal_importmodel_json_descr']	= "Вставьте в это поле данные JSON для импорта информации о моделях и группах моделей устройств.";
// Страница "Импорт/Экспорт": Сообщения
$lang['settings_importexport_flashdata_error_dataformatgroup']	= "Ошибка формата данных (некорректная информация о группе устройств). Пожалуйста, проверьте корректность данных и повторите попытку.";
$lang['settings_importexport_flashdata_error_dataformatmodel']	= "Ошибка формата данных (некорректная информация о моделях в группе устройств). Пожалуйста, проверьте корректность данных и повторите попытку.";
$lang['settings_importexport_flashdata_error_dbparams']		= "Ошибка БД. Не удалось создать шаблон параметров";
$lang['settings_importexport_flashdata_error_dbgroups']		= "Ошибка БД. Не удалось создать группу устройств";
$lang['settings_importexport_flashdata_error_dbmodel']		= "Ошибка БД. Не удалось создать модель устройства";
$lang['settings_importexport_flashdata_error_jsonformat']	= "Ошибка формата JSON. Пожалуйста, проверьте корректность данных и повторите попытку.";
$lang['settings_importexport_flashdata_success']			= "Импорт завершен успешно. <br />Результаты импорта:";
$lang['settings_importexport_flashdata_result_addparams']	= "Добавлены шаблоны параметров";
$lang['settings_importexport_flashdata_result_addgroups']	= "Добавлены группы устройств";
$lang['settings_importexport_flashdata_result_addmodels']	= "Добавлены модели устройств";
