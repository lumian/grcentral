...
$lang['settings_syssettings_description_text']				= "В данном разделе вы можете настроить некоторые важные опции системы GRCentral. Не забудьте сохранить настройки после внесения изменений.";
...
$lang['settings_syssettings_pb_generate_enable_help']		= "При включении данной функции, будет доступна возможность получения Phonebook XML файлов девайсами. При выключении раздел справочника отключен не будет, а вместо phonebook xml файла будет отдаваться 404 ошибка.";
